...
$rutaModulo       = app_url('src/' . ltrim((string) ($modulo['ruta'] ?? ''), '/'));
$meses            = [
    1 => 'Enero',
    2 => 'Febrero',
    3 => 'Marzo',
...
<html lang="es">
  <head>
    ...
    <style>
      ...
      html[data-sietelsa-theme=dark] .module-shell {
      ...
      html[data-sietelsa-theme=dark] .module-shell,
      html[data-sietelsa-theme=dark] .module-shell .content-wrapper,
      html[data-sietelsa-theme=dark] .module-shell .main-panel,
      html[data-sietelsa-theme=dark] .module-shell .page-body-wrapper {
        background: var(--module-dark-page) !important;
        color: var(--module-dark-text);
      }

      html[data-sietelsa-theme=dark] .module-shell .card,
      html[data-sietelsa-theme=dark] .module-hero,
      html[data-sietelsa-theme=dark] .module-actions-card,
      html[data-sietelsa-theme=dark] .module-secondary-block,
      html[data-sietelsa-theme=dark] .module-table-wrap {
      ...
      html[data-sietelsa-theme=dark] .module-title,
      html[data-sietelsa-theme=dark] .module-summary-value,
      html[data-sietelsa-theme=dark] .module-status-pill strong,
      html[data-sietelsa-theme=dark] .module-secondary-heading h4,
      html[data-sietelsa-theme=dark] .module-secondary-trigger,
      html[data-sietelsa-theme=dark] .module-modal h3,
      html[data-sietelsa-theme=dark] .module-choice .font-weight-bold,
      html[data-sietelsa-theme=dark] .module-dte-title,
      html[data-sietelsa-theme=dark] .module-loading-title {
        color: var(--module-dark-text) !important;
      }

      html[data-sietelsa-theme=dark] .module-copy,
      html[data-sietelsa-theme=dark] .module-summary-label,
      html[data-sietelsa-theme=dark] .module-summary-note,
      html[data-sietelsa-theme=dark] .module-secondary-heading p,
      html[data-sietelsa-theme=dark] .module-empty-row td,
      html[data-sietelsa-theme=dark] .module-loading-copy,
      html[data-sietelsa-theme=dark] .module-import-list,
      html[data-sietelsa-theme=dark] .module-dte-fallback,
      html[data-sietelsa-theme=dark] .module-modal .text-muted,
      html[data-sietelsa-theme=dark] .module-shell .text-muted {
        color: var(--module-dark-muted) !important;
      }

      html[data-sietelsa-theme=dark] .module-chip,
      html[data-sietelsa-theme=dark] .module-types-summary,
      html[data-sietelsa-theme=dark] .module-summary-card,
      html[data-sietelsa-theme=dark] .module-status-pill,
      html[data-sietelsa-theme=dark] .module-empty-state,
      html[data-sietelsa-theme=dark] .module-table-meta,
      html[data-sietelsa-theme=dark] .module-table-pager,
      html[data-sietelsa-theme=dark] .module-secondary-body,
      html[data-sietelsa-theme=dark] .module-secondary-trigger,
      html[data-sietelsa-theme=dark] .module-loading-card {
      ...
      html[data-sietelsa-theme=dark] .module-types-summary strong,
      html[data-sietelsa-theme=dark] .module-types-summary i,
      html[data-sietelsa-theme=dark] .module-eyebrow {
        color: #a29df0 !important;
      }

      html[data-sietelsa-theme=dark] .module-search .input-group-text,
      html[data-sietelsa-theme=dark] .module-search .form-control,
      html[data-sietelsa-theme=dark] .module-shell .form-control,
      html[data-sietelsa-theme=dark] .module-shell .form-select,
      html[data-sietelsa-theme=dark] .module-shell select,
      html[data-sietelsa-theme=dark] .module-shell textarea,
      html[data-sietelsa-theme=dark] .module-shell input[type="text"],
      html[data-sietelsa-theme=dark] .module-shell input[type="number"],
      html[data-sietelsa-theme=dark] .module-shell input[type="date"],
      html[data-sietelsa-theme=dark] .module-shell input[type="file"] {
        background: #0c121b !important;
        border-color: #334052 !important;
        color: var(--module-dark-text) !important;
      }

      html[data-sietelsa-theme=dark] .module-search .input-group-text.bg-white {
        background: #0c121b !important;
      }

      html[data-sietelsa-theme=dark] .module-shell .form-control:focus,
      html[data-sietelsa-theme=dark] .module-shell .form-select:focus,
      html[data-sietelsa-theme=dark] .module-shell select:focus,
      html[data-sietelsa-theme=dark] .module-shell textarea:focus,
      html[data-sietelsa-theme=dark] .module-shell input:focus {
      ...
      html[data-sietelsa-theme=dark] .module-shell .form-control::placeholder {
        color: #687589;
      }

      html[data-sietelsa-theme=dark] .module-status-strip,
      html[data-sietelsa-theme=dark] .module-file-hint,
      html[data-sietelsa-theme=dark] .module-secondary-body,
      html[data-sietelsa-theme=dark] .module-table-pager {
        border-color: var(--module-dark-border) !important;
      }

      html[data-sietelsa-theme=dark] .module-status-pill.is-ok {
        background: rgba(123, 200, 155, 0.12) !important;
        border-color: rgba(123, 200, 155, 0.28) !important;
        color: #b9e8ca !important;
      }

      html[data-sietelsa-theme=dark] .module-status-pill.is-ok strong,
      html[data-sietelsa-theme=dark] .module-status-pill.is-ok i {
        color: #b9e8ca !important;
      }

      html[data-sietelsa-theme=dark] .module-modal .modal-content {
        background: var(--module-dark-panel) !important;
        border-color: var(--module-dark-border) !important;
        box-shadow: 0 24px 64px rgba(0, 0, 0, 0.34) !important;
      }

      html[data-sietelsa-theme=dark] .module-modal .modal-header,
      html[data-sietelsa-theme=dark] .module-modal .modal-body,
      html[data-sietelsa-theme=dark] .module-modal .modal-footer {
        background: var(--module-dark-panel) !important;
        border-color: var(--module-dark-border) !important;
      }

      html[data-sietelsa-theme=dark] .module-modal-eyebrow,
      html[data-sietelsa-theme=dark] .module-company-pill,
      html[data-sietelsa-theme=dark] .btn-module-soft {
        background: rgba(139, 134, 217, 0.14) !important;
        border-color: rgba(139, 134, 217, 0.22) !important;
        color: #c8c3ff !important;
      }

      html[data-sietelsa-theme=dark] .module-choice,
      html[data-sietelsa-theme=dark] .module-period-preview,
      html[data-sietelsa-theme=dark] .module-dte-preview {
        background: var(--module-dark-panel-soft) !important;
        border-color: var(--module-dark-border) !important;
        color: var(--module-dark-text) !important;
        box-shadow: none !important;
      ...
      html[data-sietelsa-theme=dark] .module-choice:hover {
        background: #1a2432 !important;
        border-color: #566176 !important;
      }

      html[data-sietelsa-theme=dark] .module-dte-badge,
      html[data-sietelsa-theme=dark] .module-dte-badge.is-tax-credit,
      html[data-sietelsa-theme=dark] .module-dte-badge.is-retention {
        background: #202a38 !important;
        border-color: #39465a !important;
        color: #d8dee8 !important;
      }

      html[data-sietelsa-theme=dark] .module-dte-badge.is-credit-note {
        background: rgba(185, 28, 28, 0.14) !important;
        border-color: rgba(248, 113, 113, 0.32) !important;
        color: #fecaca !important;
      }

      html[data-sietelsa-theme=dark] .module-dte-badge.is-debit-note {
        background: rgba(154, 52, 18, 0.16) !important;
        border-color: rgba(251, 146, 60, 0.3) !important;
        color: #fed7aa !important;
      }

      html[data-sietelsa-theme=dark] .btn-module,
      html[data-sietelsa-theme=dark] .module-page-btn.is-active {
      ...
      html[data-sietelsa-theme=dark] .btn-module:hover,
      html[data-sietelsa-theme=dark] .btn-module:focus {
        background: #635db8 !important;
        border-color: #635db8 !important;
      }

      html[data-sietelsa-theme=dark] .btn-module-outline,
      html[data-sietelsa-theme=dark] .module-page-btn,
      html[data-sietelsa-theme=dark] .module-action-zone .btn-outline-secondary {
      ...
      html[data-sietelsa-theme=dark] .btn-module-outline:hover,
      html[data-sietelsa-theme=dark] .btn-module-outline:focus,
      html[data-sietelsa-theme=dark] .module-page-btn:hover,
      html[data-sietelsa-theme=dark] .module-page-btn:focus,
      html[data-sietelsa-theme=dark] .module-action-zone .btn-outline-secondary:hover {
        background: #1b2634 !important;
        border-color: #66758c !important;
        color: #fff !important;
      }

      html[data-sietelsa-theme=dark] .btn-outline-danger {
        background: transparent !important;
        border-color: rgba(248, 113, 113, 0.48) !important;
        color: #fca5a5 !important;
      }

      html[data-sietelsa-theme=dark] .btn-outline-danger:hover,
      html[data-sietelsa-theme=dark] .btn-outline-danger:focus {
        background: rgba(185, 28, 28, 0.16) !important;
        color: #fecaca !important;
      }

      html[data-sietelsa-theme=dark] .module-shell .btn:disabled,
      html[data-sietelsa-theme=dark] .module-shell .btn.disabled {
      ...
      html[data-sietelsa-theme=dark] .module-export-menu {
        background: #121923 !important;
        border-color: var(--module-dark-border) !important;
        box-shadow: 0 18px 40px rgba(0, 0, 0, 0.26) !important;
      }

      html[data-sietelsa-theme=dark] .module-export-heading {
        color: var(--module-dark-muted) !important;
      }

      html[data-sietelsa-theme=dark] .module-export-item {
        color: var(--module-dark-text) !important;
      }

      html[data-sietelsa-theme=dark] .module-export-item:hover,
      html[data-sietelsa-theme=dark] .module-export-item:focus {
        background: #1b2634 !important;
        color: #fff !important;
      }

      html[data-sietelsa-theme=dark] .module-table,
      html[data-sietelsa-theme=dark] .module-table td,
      html[data-sietelsa-theme=dark] .module-table th {
        background: transparent !important;
        border-color: var(--module-dark-border) !important;
        color: var(--module-dark-text) !important;
      }

      html[data-sietelsa-theme=dark] .module-table thead th {
        background: #151e2a !important;
        color: #eef2f7 !important;
      }

      html[data-sietelsa-theme=dark] .module-table tbody tr.total-row td,
      html[data-sietelsa-theme=dark] .module-table tbody tr.credit-note-row td,
      html[data-sietelsa-theme=dark] .module-row-actions {
        background: #151e2a !important;
      }

      html[data-sietelsa-theme=dark] .document-type-badge {
        background: #202a38 !important;
        color: #d8dee8 !important;
      }

      html[data-sietelsa-theme=dark] .modal-backdrop.show {
        opacity: 0.72;
      }

      html[data-sietelsa-theme=dark] .module-loading-overlay {
        background: rgba(4, 6, 10, 0.5);
      }

      html[data-sietelsa-theme=dark] .module-loading-bar {
        background: #253143;
      }

      html[data-sietelsa-theme=dark] .module-loading-bar::after {
      ...
      html[data-sietelsa-theme=dark] .module-modal .modal-backdrop,
      html[data-sietelsa-theme=dark] .modal-backdrop {
      ...
      html[data-sietelsa-theme=dark] .module-modal .modal-dialog {
      ...
      html[data-sietelsa-theme=dark] .module-modal .modal-header .d-flex {
        align-items: center !important;
      }

      html[data-sietelsa-theme=dark] .module-modal .modal-header h3 {
        margin: 0;
      ...
      html[data-sietelsa-theme=dark] .module-modal .btn-close {
        width: 38px;
        height: 38px;
        margin: 0;
        border-radius: 12px;
      ...
      html[data-sietelsa-theme=dark] .module-modal .btn-close:hover,
      html[data-sietelsa-theme=dark] .module-modal .btn-close:focus {
      ...
      html[data-sietelsa-theme=dark] .module-choice + .module-choice,
      html[data-sietelsa-theme=dark] .module-modal .d-grid .module-choice {
        margin-top: 0;
      }

      html[data-sietelsa-theme=dark] .module-choice:hover,
      html[data-sietelsa-theme=dark] .module-choice:focus {
        background: #182231 !important;
        border-color: #435068 !important;
      }

      html[data-sietelsa-theme=dark] .module-choice-body {
        gap: 1rem;
      }
      ...
      html[data-sietelsa-theme=dark] .period-work-title,
      html[data-sietelsa-theme=dark] .period-module-name {
        color: #f2f5f9 !important;
      }

      html[data-sietelsa-theme=dark] .period-work-subtitle,
      html[data-sietelsa-theme=dark] .period-module-kicker {
        color: #a8b2c1 !important;
      }

      html[data-sietelsa-theme=dark] .period-field label {
        color: #c8d1de !important;
      }

      html[data-sietelsa-theme=dark] .period-field .form-control {
        background: #151d29 !important;
        border-color: #2b3545 !important;
        color: #edf2f8 !important;
      }

      html[data-sietelsa-theme=dark] .period-field .form-control:focus {
        border-color: #6f68d8 !important;
        box-shadow: 0 0 0 0.2rem rgba(111, 104, 216, 0.24) !important;
      }

      html[data-sietelsa-theme=dark] .period-module-icon {
        background: #111722 !important;
        color: #c8c3ff !important;
        box-shadow: inset 0 0 0 1px #2b3545;
      }

      html[data-sietelsa-theme=dark] .module-choice small,
      html[data-sietelsa-theme=dark] .module-modal .small,
      html[data-sietelsa-theme=dark] .module-modal .text-uppercase.small {
        color: #a8b2c1 !important;
      }
      ...
      html[data-sietelsa-theme=dark] .module-modal .d-grid {
        gap: 0.8rem !important;
      }

      html[data-sietelsa-theme=dark] .module-modal .btn-module-soft {
        background: #282849 !important;
        border: 1px solid #403f68 !important;
        color: #ddd9ff !important;
      }

      html[data-sietelsa-theme=dark] .module-modal .btn-module-outline {
        background: #1a2432 !important;
        border-color: #46546c !important;
        color: #dce3ee !important;
      }

      html[data-sietelsa-theme=dark] .module-modal .btn-module-outline:hover,
      html[data-sietelsa-theme=dark] .module-modal .btn-module-outline:focus {
        background: #223044 !important;
        border-color: #5a6982 !important;
        color: #fff !important;
      }

      html[data-sietelsa-theme=dark] .module-modal .btn-outline-danger {
        background: #281a20 !important;
        border-color: #6e3b45 !important;
        color: #f6b4bd !important;
      }

      html[data-sietelsa-theme=dark] .module-modal .btn-outline-danger:hover,
      html[data-sietelsa-theme=dark] .module-modal .btn-outline-danger:focus {
        background: #3a2028 !important;
        border-color: #8a4653 !important;
        color: #ffd2d8 !important;
      }

      html[data-sietelsa-theme=dark] #bookChoiceModal .modal-body {
        display: block;
      }

      html[data-sietelsa-theme=dark] #bookChoiceModal .module-choice:first-of-type {
        margin-bottom: 1.25rem !important;
      }

      html[data-sietelsa-theme=dark] #bookChoiceModal .modal-footer {
        padding-top: 0.15rem;
      }

      html[data-sietelsa-theme=dark] #bookChoiceModal .modal-footer .btn {
        min-height: 42px;
  ...
  <body>
                        ...
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu dropdown-menu-end module-export-menu">
                            <?php if ($libroActivo): ?>
                              ...
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=hacienda_compras">
                              ...
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=hacienda_f14">
                                <i class="mdi mdi-file-delimited-outline"></i>
                                CSV Anexo F14
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=hacienda_casilla_66">
                                <i class="mdi mdi-file-delimited-outline"></i>
                                CSV Casilla 66
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=hacienda_casilla_162">
                                <i class="mdi mdi-file-delimited-outline"></i>
                                CSV Casilla 162
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=hacienda_casilla_163">
                                <i class="mdi mdi-file-delimited-outline"></i>
                                CSV Casilla 163
                              </a>
                              <?php endif; ?>
                              ...
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=excel">
                                <i class="mdi mdi-file-excel-outline"></i>
                                Excel interno
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=csv">
                                <i class="mdi mdi-file-delimited-outline"></i>
                                CSV interno
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=pdf" target="_blank" rel="noopener">
                                <i class="mdi mdi-file-pdf-box"></i>
                                PDF
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&modo=json&formato=json" target="_blank" rel="noopener">
                              ...
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&reporte=fuera_periodo&formato=excel">
                                <i class="mdi mdi-file-excel-outline"></i>
                                Fuera de periodo en Excel
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&reporte=fuera_periodo&formato=pdf" target="_blank" rel="noopener">
                                <i class="mdi mdi-file-pdf-box"></i>
                                Fuera de periodo en PDF
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&reporte=repetidas&formato=excel">
                                <i class="mdi mdi-file-excel-outline"></i>
                                Repetidas en Excel
                              </a>
                              <a class="dropdown-item module-export-item" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&reporte=repetidas&formato=pdf" target="_blank" rel="noopener">
                                <i class="mdi mdi-file-pdf-box"></i>
                                Repetidas en PDF
                              </a>
                            <?php endif; ?>
                  ...
                  <div class="card-body">
                      ...
                      <div class="collapse" id="secondaryRepeatedDocs">
                        <div class="module-secondary-body">
                          <div class="d-flex flex-wrap justify-content-end gap-2 mb-3">
                            <a class="btn btn-sm btn-outline-primary" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&reporte=repetidas&formato=excel">
                              <i class="mdi mdi-file-excel-outline me-1"></i> Excel
                            </a>
                            <a class="btn btn-sm btn-outline-primary" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&reporte=repetidas&formato=pdf" target="_blank" rel="noopener">
                    ...
                    <div class="module-secondary-block">
                      ...
                      <div class="collapse" id="secondaryOutOfPeriodDocs">
                        <div class="module-secondary-body">
                          <div class="d-flex flex-wrap justify-content-end gap-2 mb-3">
                            <a class="btn btn-sm btn-outline-primary" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&reporte=fuera_periodo&formato=excel">
                              <i class="mdi mdi-file-excel-outline me-1"></i> Excel
                            </a>
                            <a class="btn btn-sm btn-outline-primary" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&reporte=fuera_periodo&formato=pdf" target="_blank" rel="noopener">
                              <i class="mdi mdi-file-pdf-box me-1"></i> PDF
                            </a>
                          </div>
                          <div class="table-responsive module-table-shell is-pending">
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
	        ...
	        const preferencesEndpoint = <?php echo json_encode(app_url('src/api/preferencias/libro_columnas.php'), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
        const modalMap = {
