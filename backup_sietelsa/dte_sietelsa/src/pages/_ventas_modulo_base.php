                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                      <a class="btn btn-outline-primary btn-sm" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=excel">
                      ...
                      <a class="btn btn-primary btn-sm" href="<?php echo htmlspecialchars(app_url('src/api/facturas/exportar.php')); ?>?id_libro=<?php echo (int) $libroActivo['id']; ?>&formato=hacienda_contribuyentes">
