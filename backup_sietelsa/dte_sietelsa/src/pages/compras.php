...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'select_company') {
        ...
        redirect_to('src/pages/compras.php');
    }
...
<html lang="es">
  <head>
    ...
    <title>Libro de Compras - <?php echo htmlspecialchars(app_name()); ?></title>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="compras-inline-badges">
                      <span class="compras-inline-badge"><i class="mdi mdi-check-circle-outline"></i> Tipos válidos 01, 03, 05 y 06</span>
                      ...
                      <div class="compras-result-list">
                        ...
                        <div class="compras-result-item">
                          ...
                          <small>
                            ...
                            <?php endif; ?>
                            <?php if (!empty($invalida['numero_control'])): ?>
                              · <?php echo htmlspecialchars((string) $invalida['numero_control']); ?>
                            <?php endif; ?>
                          </small>
                          <?php endif; ?>
                        </div>
