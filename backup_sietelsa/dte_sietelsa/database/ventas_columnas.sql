...
ALTER TABLE facturas
    ...
    ADD COLUMN IF NOT EXISTS compras_exentas DECIMAL(10,2) DEFAULT 0.00,
    ADD COLUMN IF NOT EXISTS compras_gravadas DECIMAL(10,2) DEFAULT 0.00,
    ADD COLUMN IF NOT EXISTS impuestos_calculados DECIMAL(10,2) DEFAULT 0.00,
    ADD COLUMN IF NOT EXISTS fovial_otros DECIMAL(10,2) DEFAULT 0.00;
